...
for linha in pagina_clientes.iter_rows(min_row=1): # iter_rows, percorre por todas as linhas da planilha, iniando da segunda linha
    ...
    mensagem = f'Fala {nome}, aqui é Jakson Capixaba. Estou na luta. Me ajude a multiplicar e me fazer vereador de Natal. O vereador da torcida do ABC. Vote ✅2️⃣0️⃣.2️⃣3️⃣4️⃣✅, a bola da vez.'
...
# criar link personalizados do whatsapp e enviar mensagens para cada cliente, com base na planilha  
    try:
        ...
        sleep(8)
        pyautogui.moveTo(x=-2027, y=288)
        pyautogui.dragTo(1281, 487, duration=2)
